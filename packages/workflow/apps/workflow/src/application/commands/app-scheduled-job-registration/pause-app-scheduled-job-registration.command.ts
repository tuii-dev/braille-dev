...
export class PauseAppScheduledJobRegistrationCommand implements ICommand {
  constructor(
...
@Injectable()
@CommandHandler(PauseAppScheduledJobRegistrationCommand)
export class PauseAppScheduledJobRegistrationCommandHandler
  implements ICommandHandler
{
  constructor(
    private readonly appScheduledJobRegistrationRepository: AppScheduledJobRegistrationRepository,
    private readonly utilsService: UtilsService,
    @InjectPinoLogger(PauseAppScheduledJobRegistrationCommandHandler.name)
    private readonly logger: PinoLogger,
  ) {}

  async execute(
    command: PauseAppScheduledJobRegistrationCommand,
