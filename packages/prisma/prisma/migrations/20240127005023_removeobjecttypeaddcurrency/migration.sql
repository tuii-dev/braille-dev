...
-- AlterEnum
BEGIN;
CREATE TYPE "FieldDataTypeEnum_new" AS ENUM ('STRING', 'NUMBER', 'ENUM', 'DATE', 'ARRAY', 'BOOLEAN', 'CURRENCY');
ALTER TABLE "Definition" ALTER COLUMN "type" TYPE "FieldDataTypeEnum_new" USING ("type"::text::"FieldDataTypeEnum_new");
